...
<div class="container" id="container">
    <form method="post" enctype="multipart/form-data" action=<?php echo "modif_jeux.php?id_produit=".$product["id_produit"]?>>
        <h1> Mise à jour d'un jeux </h1>
        ...
        <input type="submit" value="modifier un jeux" class="button"> 
      </form>
